...
class NewEditor extends React.Component {
    ...
    saveContent = (editorState) => {
       ...
       window.localStorage.setItem('content', rawData);
       axios.post('http://localhost:8080/newpost', rawData)
    ...
    render() {
      ...
      toolContiner = <div className='toolContainer'>
        <BlockStyleControls
      ...
      return (
        <div className="RichEditor-root">
          ...
          <button onClick={()=>this.saveContent(editorState)}>Save</button>
